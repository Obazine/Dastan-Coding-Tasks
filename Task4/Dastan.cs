    ...
    class Dastan
    {
        ...
        public void PlayGame()
        {
            ...
            while (!GameOver)
            {
                ...
                do
                {
                    Console.Write("Choose move option to use from queue (1 to 3) or 8 to take a peek at the opponent's hand or 9 to take the offer: ");
                    ...
                    {
                        Console.WriteLine(OpposingPlayer.GetJustQueue());
