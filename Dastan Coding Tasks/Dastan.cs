...
namespace Dastan
{
    class Dastan
    {
        ...
        {
            string[] playerNames = CreateCustomPlayers();
            Players.Add(new Player(playerNames[0], 1));
            Players.Add(new Player(playerNames[1], -1));
            CreateMoveOptions();
            NoOfRows = R;
            NoOfColumns = C;
        ...
        private string[] CreateCustomPlayers()
        {
            string playerOneName;
            string playerTwoName;
            Console.WriteLine("Player 1, Please enter your custom username... ");
            playerOneName = Console.ReadLine();
            do
            {
                Console.WriteLine("Player 2, Please enter your custom username... ");
                playerTwoName = Console.ReadLine();
                if (playerOneName == playerTwoName)
                {
                    Console.WriteLine("You can not enter the same name as player 1. Please try again.");
                }
